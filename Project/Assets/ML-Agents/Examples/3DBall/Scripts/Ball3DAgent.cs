...
public class Ball3DAgent : Agent
{
    ...
    public GameObject ball;  // The single ball
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        if (useVecObs)
        {
            // Add observations of the agent's rotation and ball velocity
    ...
    public override void OnEpisodeBegin()
    {
        ...
        // Change the color of the ball at the beginning of each episode
        ChangeBallColor();

...
public class AgentSoccer : Agent
{
    ...
    public override void Initialize()
    {
        ...
        // Dynamically attach SoundSensorComponent if missing
        ...
        if (soundSensorComponent == null)
        {
            ...
            Debug.Log("SoundSensorComponent dynamically added to the agent.");
        }
    }
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        if (soundSensorComponent != null)
        {
            ...
            {
                Debug.LogWarning("SoundSensorComponent returned no sound data.");
            }
        }
        else
        {
